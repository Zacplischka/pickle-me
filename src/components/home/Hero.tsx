...
export function Hero() {
    return (
        <section className="relative w-full py-20 md:py-32 lg:py-40 bg-primary overflow-hidden">
            ...
            <div className="container relative z-20 mx-auto px-4 md:px-6 flex flex-col items-center text-center gap-6">
                ...
                <div className="w-full max-w-2xl mt-8 p-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-2xl flex flex-col md:flex-row gap-2">
                    ...
                    <Button size="lg" className="h-12 md:w-auto w-full bg-secondary hover:bg-secondary/90 text-white font-semibold text-lg px-8 rounded-xl shadow-lg shadow-secondary/20">
                ...
                <div className="flex items-center gap-4 mt-6 text-sm text-primary-foreground/60">
                    <span>Popular:</span>
                    <span className="underline decoration-secondary decoration-2 underline-offset-4 cursor-pointer hover:text-white">Indoor Courts</span>
                    <span className="underline decoration-secondary decoration-2 underline-offset-4 cursor-pointer hover:text-white">Melbourne</span>
                    <span className="underline decoration-secondary decoration-2 underline-offset-4 cursor-pointer hover:text-white">Free to Play</span>
                </div>
            </div>
        </section>
    );
